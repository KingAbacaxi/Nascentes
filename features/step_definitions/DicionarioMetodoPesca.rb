Dado("que tenha acessado o SIGAM") do
  ...
  Quando("clicar entrar no modulo do SIPAI") do
    @Hs = HomeSigam.new
    @Hs.menuPortal.hover
    @Hs.menuPortais.click
    @pesquisa = DicionarioPadrao.new
    @pesquisa.pesquisar('Nome do Portal','Contém','sipai')
    @pesquisa.btnAdicionarPesquisa.click
    @PortaisS = PortaisSigam.new
    @PortaisS.btnPesquisar.click
    @PortaisS.clicarGrid(4)
