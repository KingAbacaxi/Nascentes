...
#UserStory 46054-PortalAIA-Incluir parâmetro no dicionário de Infrações
#Eduardo Amorim

#COMO administrador da Fiscalização QUERO controlar as classes infracionais que irão permitir o Atendimento Digita
#PARA que eu possa ter o controle dos atendimentos a serem realizados pelos interessados no Portal AIA
#28/03/2019
...
Então sistema deve apresentar tela de cadastro de um novo item Classe Infração Nivel 1 com os campos Classe Infração - Código Classe infração - Ordem - Descrição 
E as flags Ativo - Atendimento Digital
...
E clicar em Classe Infração Nivel 1
Quando clicar para adicionar um Novo Classe Infração Nivel 1
E Preencher os campos Classe Infração '' - código Classe Infração '' - Ordem '' - Descrição '' - Ativo '' - Atendimento Digital ''
E incluir um tipo infração ao GRID ''
...
Cenario: Verificar edição da flag atendimento Ambiental
...
E clicar em desflagar o Atentimento Digital
E clicar em Atualizar
Então sistema deve gravar a alteração exibir a mensagem 'Dados salvos com sucesso'
