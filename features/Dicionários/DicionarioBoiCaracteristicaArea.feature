...
Quando Preecher os campos de um novo BOI Caracteristica da Área titulo 'Terreno com Declinio' ordem '1' Ativo 'sim' descricao 'Alagamento causado por chuvas' 
...
Quando pesquisar um BOI Caracteristica da Área pelo titulo 'Terreno'
Então sistema deve exibir no Grid somente os itens que tenham 'Terreno' no titulo
...
Quando pesquisar um BOI Caracteristica da Área pelo titulo 'Terreno'
E clicar em editar no grid BOI Caracteristica da Área
E clicar em excluir um um BOI Caracteristica da Área
