...
@CriarAbaMensagemProcesso

Funcionalidade: Criar Aba Mensagem dentro do Processo

#UserStory - 46033 - Criar Aba Mensagem dentro de (Processo)
...
Cenário: Conferir apresentação da aba Mensagem no processo
    ...
    E pesquisar o Processo em questão ''
    E selecionar a Atividade
    Quando selecionar a aba Mensagem
