...
@CriarAtividadeProjetoPrateleira

Funcionalidade: Criar atividade Projeto de Prateleira

#UserStory- 39454 - Criar atividade Projeto de Prateleira
...
#Story
#COMO técnico
#QUERO que seja criada a categoria de Projeto de Prateleira
#PARA que seja associada a um Processo do Programa Nascentes.

Cenário: Conferir criação automática da atividade quando Projeto de Prateleira
